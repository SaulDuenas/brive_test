...
namespace StoreApp.Negocio
{
    public partial class StoreAppContext_OLD02 : DbContext
    {
        public StoreAppContext_OLD02()
        {
        }

        public StoreAppContext_OLD02(DbContextOptions<StoreAppContext_OLD02> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=StoreApp;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Existencia>(entity =>
            {
                ...
                entity.HasOne(d => d.IdproductoNavigation)
                    ...
                    .HasConstraintName("FK_INVENTAR_REFERENCE_PRODUCTO");

                entity.HasOne(d => d.IdsucursalNavigation)
                    .WithMany(p => p.Existencia)
                    .HasForeignKey(d => d.IdSucursal)
                    .HasConstraintName("FK_INVENTAR_REFERENCE_SUCURSAL");
            });
